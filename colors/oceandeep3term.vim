...
highlight Cursor        gui=None guibg=PaleTurquoise3 guifg=Black
highlight CursorIM gui=bold guifg=white guibg=Black
...
"highlight Normal        gui=None guibg=grey10 guifg=honeydew2
highlight Normal        gui=None guibg=grey6 guifg=honeydew2
highlight Question      gui=bold  guifg=SeaGreen2 guibg=bg
"highlight Search        gui=NONE guibg=LightSkyBlue4 guifg=NONE
highlight Search term=reverse ctermbg=Yellow ctermfg=Black guibg=Orange guifg=Black
...
highlight SpecialKey    guifg=LightSkyBlue3
...
highlight Comment       gui=None guifg=#B09080
